...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.P1_Text_Buzzer2 = Entry(self.Frame6, textvariable=self.P1_Text_Buzzer2Var, font=('',10))
        ...
        self.P1_Text_Buzzer1 = Entry(self.Frame6, textvariable=self.P1_Text_Buzzer1Var, font=('',10))
        ...
        self.P1_Text_Diode1 = Entry(self.Frame6, textvariable=self.P1_Text_Diode1Var, font=('',10))
        ...
        self.P1_Text_Diode2 = Entry(self.Frame6, textvariable=self.P1_Text_Diode2Var, font=('',10))
        ...
        self.P1_Text_Diode3 = Entry(self.Frame6, textvariable=self.P1_Text_Diode3Var, font=('',10))
        ...
        self.P3_Combo_PSAMposition = Combobox(self.Frame9, text='1 ', textvariable=self.P3_Combo_PSAMpositionVar, values=self.P3_Combo_PSAMpositionList, font=('',10))
        ...
        self.P3_Text_Blocks = Entry(self.Frame10, textvariable=self.P3_Text_BlocksVar, font=('',10))
        ...
        self.Text_StarBlock = Entry(self.Frame10, textvariable=self.Text_StarBlockVar, font=('',10))
        ...
        self.P3_Text_MAID = Entry(self.Frame10, textvariable=self.P3_Text_MAIDVar, font=('',10))
        ...
        self.P3_Text_Tested = Entry(self.Frame10, textvariable=self.P3_Text_TestedVar, font=('',10))
        ...
        self.P3_Text_TestTotal = Entry(self.Frame10, textvariable=self.P3_Text_TestTotalVar, font=('',10))
        ...
        self.P3_Text_TestTimes = Entry(self.Frame10, textvariable=self.P3_Text_TestTimesVar, font=('',10))
        ...
        self.P3_Text_ReadTimer = Entry(self.Frame10, textvariable=self.P3_Text_ReadTimerVar, font=('',10))
        ...
        self.P0_Combo_antenna = Combobox(self.Frame4, text='1 ', textvariable=self.P0_Combo_antennaVar, values=self.P0_Combo_antennaList, font=('',10))
        ...
        self.P0_Combo_port = Combobox(self.Frame1, text='COM1', textvariable=self.P0_Combo_portVar, values=self.P0_Combo_portList, font=('',10))
        ...
        self.P0_Combo_region = Combobox(self.Frame1, text='CQ', textvariable=self.P0_Combo_regionVar, values=self.P0_Combo_regionList, font=('',10))
