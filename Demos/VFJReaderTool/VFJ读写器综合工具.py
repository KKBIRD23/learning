...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.style.configure("TFrame4.TLabelframe", font=("", 10))
        self.style.configure("TFrame4.TLabelframe.Label", font=("", 10))
        ...
        self.style.configure("TFrame1.TLabelframe", font=("", 10))
        self.style.configure("TFrame1.TLabelframe.Label", font=("", 10))
        self.Frame1 = LabelFrame(self.top, text="基本设置", style="TFrame1.TLabelframe")
        self.Frame1.place(relx=0.019, rely=0.0, relwidth=0.573, relheight=0.184)

        self.style.configure("TFrame3.TLabelframe", font=("", 10))
        self.style.configure("TFrame3.TLabelframe.Label", font=("", 10))
        ...
        self.style.configure("TFrame6.TLabelframe", font=("", 10))
        self.style.configure("TFrame6.TLabelframe.Label", font=("", 10))
        self.Frame6 = LabelFrame(
            self.TabStrip1__Tab1, text="", style="TFrame6.TLabelframe"
        )
        self.Frame6.place(relx=0.347, rely=0.086, relwidth=0.622, relheight=0.827)
        self.P1_Text_Buzzer2Var = StringVar(value="2")
        self.P1_Text_Buzzer2 = Entry(
            self.Frame6, textvariable=self.P1_Text_Buzzer2Var, font=("", 10)
        )
        ...
        self.P1_Text_Buzzer2.place(
            relx=0.795, rely=0.654, relwidth=0.053, relheight=0.163
        )
        self.P1_Text_Buzzer1Var = StringVar(value="2")
        self.P1_Text_Buzzer1 = Entry(
            self.Frame6, textvariable=self.P1_Text_Buzzer1Var, font=("", 10)
        )
        ...
        self.P1_Text_Buzzer1.place(
            relx=0.575, rely=0.654, relwidth=0.053, relheight=0.163
        )
        self.P1_Command_DiodeVar = StringVar(value="发光二极管")
        self.style.configure("TP1_Command_Diode.TButton", font=("", 10))
        self.P1_Command_Diode = Button(
            self.Frame6,
            text="发光二极管",
            textvariable=self.P1_Command_DiodeVar,
            command=self.P1_Command_Diode_Cmd,
            style="TP1_Command_Diode.TButton",
        )
        ...
        self.P1_Command_Diode.place(
            relx=0.152, rely=0.261, relwidth=0.188, relheight=0.216
        )
        self.P1_Command_BuzzerVar = StringVar(value="蜂鸣器")
        self.style.configure("TP1_Command_Buzzer.TButton", font=("", 10))
        self.P1_Command_Buzzer = Button(
            self.Frame6,
            text="蜂鸣器",
            textvariable=self.P1_Command_BuzzerVar,
            command=self.P1_Command_Buzzer_Cmd,
            style="TP1_Command_Buzzer.TButton",
        )
        ...
        self.P1_Command_Buzzer.place(
            relx=0.152, rely=0.627, relwidth=0.188, relheight=0.216
        )
        self.P1_Text_Diode1Var = StringVar(value="2")
        self.P1_Text_Diode1 = Entry(
            self.Frame6, textvariable=self.P1_Text_Diode1Var, font=("", 10)
        )
        ...
        self.P1_Text_Diode1.place(
            relx=0.474, rely=0.261, relwidth=0.053, relheight=0.163
        )
        self.P1_Text_Diode2Var = StringVar(value="2")
        self.P1_Text_Diode2 = Entry(
            self.Frame6, textvariable=self.P1_Text_Diode2Var, font=("", 10)
        )
        ...
        self.P1_Text_Diode2.place(
            relx=0.626, rely=0.261, relwidth=0.053, relheight=0.163
        )
        self.P1_Text_Diode3Var = StringVar(value="2")
        self.P1_Text_Diode3 = Entry(
            self.Frame6, textvariable=self.P1_Text_Diode3Var, font=("", 10)
        )
        ...
        self.P1_Text_Diode3.place(
            relx=0.778, rely=0.261, relwidth=0.053, relheight=0.163
        )
        self.Label10Var = StringVar(value="声调")
        self.style.configure("TLabel10.TLabel", anchor="w", font=("", 10))
        self.Label10 = Label(
            self.Frame6,
            text="声调",
            textvariable=self.Label10Var,
            style="TLabel10.TLabel",
        )
        ...
        self.style.configure("TLabel9.TLabel", anchor="w", font=("", 10))
        self.Label9 = Label(
            self.Frame6,
            text="发音次数",
            textvariable=self.Label9Var,
            style="TLabel9.TLabel",
        )
        ...
        self.style.configure("TLabel6.TLabel", anchor="w", font=("", 10))
        self.Label6 = Label(
            self.Frame6, text="R", textvariable=self.Label6Var, style="TLabel6.TLabel"
        )
        ...
        self.style.configure("TLabel7.TLabel", anchor="w", font=("", 10))
        self.Label7 = Label(
            self.Frame6, text="G", textvariable=self.Label7Var, style="TLabel7.TLabel"
        )
        ...
        self.style.configure("TLabel8.TLabel", anchor="w", font=("", 10))
        self.Label8 = Label(
            self.Frame6, text="Y", textvariable=self.Label8Var, style="TLabel8.TLabel"
        )
        ...
        self.style.configure("TFrame5.TLabelframe", font=("", 10))
        self.style.configure("TFrame5.TLabelframe.Label", font=("", 10))
        self.Frame5 = LabelFrame(
            self.TabStrip1__Tab1, text="", style="TFrame5.TLabelframe"
        )
        ...
        self.style.configure("TP1_Command_ReaderVer.TButton", font=("", 10))
        self.P1_Command_ReaderVer = Button(
            self.Frame5,
            text="读写器版本查询",
            textvariable=self.P1_Command_ReaderVerVar,
            command=self.P1_Command_ReaderVer_Cmd,
            style="TP1_Command_ReaderVer.TButton",
        )
        self.P1_Command_ReaderVer.setText = lambda x: self.P1_Command_ReaderVerVar.set(
            x
        )
        self.P1_Command_ReaderVer.text = lambda: self.P1_Command_ReaderVerVar.get()
        self.P1_Command_ReaderVer.place(
            relx=0.191, rely=0.157, relwidth=0.579, relheight=0.268
        )
        self.P1_Command_DllVersionVar = StringVar(value="动态库版本查询")
        self.style.configure("TP1_Command_DllVersion.TButton", font=("", 10))
        self.P1_Command_DllVersion = Button(
            self.Frame5,
            text="动态库版本查询",
            textvariable=self.P1_Command_DllVersionVar,
            command=self.P1_Command_DllVersion_Cmd,
            style="TP1_Command_DllVersion.TButton",
        )
        self.P1_Command_DllVersion.setText = (
            lambda x: self.P1_Command_DllVersionVar.set(x)
        )
        self.P1_Command_DllVersion.text = lambda: self.P1_Command_DllVersionVar.get()
        self.P1_Command_DllVersion.place(
            relx=0.191, rely=0.575, relwidth=0.579, relheight=0.268
        )
        self.TabStrip1.add(self.TabStrip1__Tab1, text="基本功能")

        self.TabStrip1__Tab2 = Frame(self.TabStrip1)
        self.style.configure("TFrame7.TLabelframe", font=("", 10))
        self.style.configure("TFrame7.TLabelframe.Label", font=("", 10))
        self.Frame7 = LabelFrame(
            self.TabStrip1__Tab2, text="", style="TFrame7.TLabelframe"
        )
        self.Frame7.place(relx=0.357, rely=0.043, relwidth=0.622, relheight=0.914)
        self.P2_Command_3F00Var = StringVar(value="选择 3F00")
        self.style.configure("TP2_Command_3F00.TButton", font=("", 10))
        self.P2_Command_3F00 = Button(
            self.Frame7,
            text="选择 3F00",
            textvariable=self.P2_Command_3F00Var,
            command=self.P2_Command_3F00_Cmd,
            style="TP2_Command_3F00.TButton",
        )
        ...
        self.P2_Command_3F00.place(
            relx=0.034, rely=0.142, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_1001Var = StringVar(value="选择 1001")
        self.style.configure("TP2_Command_1001.TButton", font=("", 10))
        self.P2_Command_1001 = Button(
            self.Frame7,
            text="选择 1001",
            textvariable=self.P2_Command_1001Var,
            command=self.P2_Command_1001_Cmd,
            style="TP2_Command_1001.TButton",
        )
        ...
        self.P2_Command_1001.place(
            relx=0.271, rely=0.142, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_1005Var = StringVar(value="读 0015")
        self.style.configure("TP2_Command_1005.TButton", font=("", 10))
        self.P2_Command_1005 = Button(
            self.Frame7,
            text="读 0015",
            textvariable=self.P2_Command_1005Var,
            command=self.P2_Command_1005_Cmd,
            style="TP2_Command_1005.TButton",
        )
        ...
        self.P2_Command_1005.place(
            relx=0.271, rely=0.426, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_1006Var = StringVar(value="读 0016")
        self.style.configure("TP2_Command_1006.TButton", font=("", 10))
        self.P2_Command_1006 = Button(
            self.Frame7,
            text="读 0016",
            textvariable=self.P2_Command_1006Var,
            command=self.P2_Command_1006_Cmd,
            style="TP2_Command_1006.TButton",
        )
        ...
        self.P2_Command_1006.place(
            relx=0.271, rely=0.71, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_DF01Var = StringVar(value="选择 DF01")
        self.style.configure("TP2_Command_DF01.TButton", font=("", 10))
        self.P2_Command_DF01 = Button(
            self.Frame7,
            text="选择 DF01",
            textvariable=self.P2_Command_DF01Var,
            command=self.P2_Command_DF01_Cmd,
            style="TP2_Command_DF01.TButton",
        )
        ...
        self.P2_Command_DF01.place(
            relx=0.524, rely=0.142, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_EF01Var = StringVar(value="读 EF01")
        self.style.configure("TP2_Command_EF01.TButton", font=("", 10))
        self.P2_Command_EF01 = Button(
            self.Frame7,
            text="读 EF01",
            textvariable=self.P2_Command_EF01Var,
            command=self.P2_Command_EF01_Cmd,
            style="TP2_Command_EF01.TButton",
        )
        ...
        self.P2_Command_EF01.place(
            relx=0.761, rely=0.142, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_EF02Var = StringVar(value="读 EF02")
        self.style.configure("TP2_Command_EF02.TButton", font=("", 10))
        self.P2_Command_EF02 = Button(
            self.Frame7,
            text="读 EF02",
            textvariable=self.P2_Command_EF02Var,
            command=self.P2_Command_EF02_Cmd,
            style="TP2_Command_EF02.TButton",
        )
        ...
        self.P2_Command_EF02.place(
            relx=0.761, rely=0.426, relwidth=0.188, relheight=0.195
        )
        self.P2_Command_EF04Var = StringVar(value="读 EF04")
        self.style.configure("TP2_Command_EF04.TButton", font=("", 10))
        self.P2_Command_EF04 = Button(
            self.Frame7,
            text="读 EF04",
            textvariable=self.P2_Command_EF04Var,
            command=self.P2_Command_EF04_Cmd,
            style="TP2_Command_EF04.TButton",
        )
        ...
        self.P2_Command_EF04.place(
            relx=0.761, rely=0.71, relwidth=0.188, relheight=0.195
        )
        self.style.configure("TFrame2.TLabelframe", font=("", 10))
        self.style.configure("TFrame2.TLabelframe.Label", font=("", 10))
        self.Frame2 = LabelFrame(
            self.TabStrip1__Tab2, text="", style="TFrame2.TLabelframe"
        )
        self.Frame2.place(relx=0.021, rely=0.043, relwidth=0.285, relheight=0.914)
        self.P2_Command_OpenCardVar = StringVar(value="打开卡片")
        self.style.configure("TP2_Command_OpenCard.TButton", font=("", 10))
        self.P2_Command_OpenCard = Button(
            self.Frame2,
            text="打开卡片",
            textvariable=self.P2_Command_OpenCardVar,
            command=self.P2_Command_OpenCard_Cmd,
            style="TP2_Command_OpenCard.TButton",
        )
        ...
        self.P2_Command_OpenCard.place(
            relx=0.074, rely=0.189, relwidth=0.41, relheight=0.243
        )
        self.P2_Command_CloseCardVar = StringVar(value="关闭卡片")
        self.style.configure("TP2_Command_CloseCard.TButton", font=("", 10))
        self.P2_Command_CloseCard = Button(
            self.Frame2,
            text="关闭卡片",
            textvariable=self.P2_Command_CloseCardVar,
            command=self.P2_Command_CloseCard_Cmd,
            style="TP2_Command_CloseCard.TButton",
        )
        self.P2_Command_CloseCard.setText = lambda x: self.P2_Command_CloseCardVar.set(
            x
        )
        self.P2_Command_CloseCard.text = lambda: self.P2_Command_CloseCardVar.get()
        self.P2_Command_CloseCard.place(
            relx=0.074, rely=0.568, relwidth=0.41, relheight=0.243
        )
        self.P2_Command_RFresetVar = StringVar(value="射频复位")
        self.style.configure("TP2_Command_RFreset.TButton", font=("", 10))
        self.P2_Command_RFreset = Button(
            self.Frame2,
            text="射频复位",
            textvariable=self.P2_Command_RFresetVar,
            command=self.P2_Command_RFreset_Cmd,
            style="TP2_Command_RFreset.TButton",
        )
        ...
        self.P2_Command_RFreset.place(
            relx=0.59, rely=0.189, relwidth=0.3, relheight=0.621
        )
        self.TabStrip1.add(self.TabStrip1__Tab2, text="卡片测试")

        self.TabStrip1__Tab3 = Frame(self.TabStrip1)
        self.style.configure("TFrame9.TLabelframe", font=("", 10))
        self.style.configure("TFrame9.TLabelframe.Label", font=("", 10))
        self.Frame9 = LabelFrame(
            self.TabStrip1__Tab3, text="PSAM Test", style="TFrame9.TLabelframe"
        )
        self.Frame9.place(relx=0.0, rely=0.043, relwidth=0.327, relheight=0.957)
        # self.P3_Text_CommandVar = StringVar(value='11')
        # self.P3_Text_Command = Entry(self.Frame9, textvariable=self.P3_Text_CommandVar, font=('',10))
        ...
        self.Text7 = Entry(self.Frame9, textvariable=self.Text7Var, font=("", 10))
        self.Text7.setText = lambda x: self.Text7Var.set(x)
        self.Text7.text = lambda: self.Text7Var.get()
        self.Text7.place(relx=0.0, rely=0.723, relwidth=1.0, relheight=0.322)
        self.P3_Command_RFpsamVar = StringVar(value="PSAM复位")
        self.style.configure("TP3_Command_RFpsam.TButton", font=("", 10))
        self.P3_Command_RFpsam = Button(
            self.Frame9,
            text="PSAM复位",
            textvariable=self.P3_Command_RFpsamVar,
            command=self.P3_Command_RFpsam_Cmd,
            style="TP3_Command_RFpsam.TButton",
        )
        ...
        self.P3_Command_RFpsam.place(
            relx=0.064, rely=0.158, relwidth=0.325, relheight=0.141
        )
        self.P3_Command_PSAMcommandVar = StringVar(value="PSAM指令")
        self.style.configure("TP3_Command_PSAMcommand.TButton", font=("", 10))
        self.P3_Command_PSAMcommand = Button(
            self.Frame9,
            text="PSAM指令",
            textvariable=self.P3_Command_PSAMcommandVar,
            command=self.P3_Command_PSAMcommand_Cmd,
            style="TP3_Command_PSAMcommand.TButton",
        )
        self.P3_Command_PSAMcommand.setText = (
            lambda x: self.P3_Command_PSAMcommandVar.set(x)
        )
        self.P3_Command_PSAMcommand.text = lambda: self.P3_Command_PSAMcommandVar.get()
        self.P3_Command_PSAMcommand.place(
            relx=0.514, rely=0.362, relwidth=0.325, relheight=0.141
        )
        self.P3_Combo_PSAMpositionList = [
            "1 ",
            "2 ",
            "3 ",
            "4 ",
        ...
        self.P3_Combo_PSAMposition = Combobox(
            self.Frame9,
            text="1 ",
            textvariable=self.P3_Combo_PSAMpositionVar,
            values=self.P3_Combo_PSAMpositionList,
            font=("", 10),
        )
        self.P3_Combo_PSAMposition.setText = (
            lambda x: self.P3_Combo_PSAMpositionVar.set(x)
        )
        ...
        self.style.configure("TP3_Command_CPUcommand.TButton", font=("", 10))
        self.P3_Command_CPUcommand = Button(
            self.Frame9,
            text="CPU指令",
            textvariable=self.P3_Command_CPUcommandVar,
            command=self.P3_Command_CPUcommand_Cmd,
            style="TP3_Command_CPUcommand.TButton",
        )
        self.P3_Command_CPUcommand.setText = (
            lambda x: self.P3_Command_CPUcommandVar.set(x)
        )
        self.P3_Command_CPUcommand.text = lambda: self.P3_Command_CPUcommandVar.get()
        self.P3_Command_CPUcommand.place(
            relx=0.064, rely=0.362, relwidth=0.325, relheight=0.141
        )
        self.Label12Var = StringVar(value="指令：")
        self.style.configure("TLabel12.TLabel", anchor="w", font=("", 10))
        self.Label12 = Label(
            self.Frame9,
            text="指令：",
            textvariable=self.Label12Var,
            style="TLabel12.TLabel",
        )
        ...
        self.style.configure("TLabel11.TLabel", anchor="w", font=("", 10))
        self.Label11 = Label(
            self.Frame9,
            text="卡槽：",
            textvariable=self.Label11Var,
            style="TLabel11.TLabel",
        )
        ...
        self.style.configure("TFrame10.TLabelframe", font=("", 10))
        self.style.configure("TFrame10.TLabelframe.Label", font=("", 10))
        self.Frame10 = LabelFrame(
            self.TabStrip1__Tab3, text="卡片连续测试", style="TFrame10.TLabelframe"
        )
        self.Frame10.place(relx=0.336, rely=0.043, relwidth=0.664, relheight=0.957)
        self.P3_Command_StopTestVar = StringVar(value="停止测试")
        self.style.configure("TP3_Command_StopTest.TButton", font=("", 10))
        self.P3_Command_StopTest = Button(
            self.Frame10,
            text="停止测试",
            textvariable=self.P3_Command_StopTestVar,
            command=self.P3_Command_StopTest_Cmd,
            style="TP3_Command_StopTest.TButton",
        )
        ...
        self.P3_Command_StopTest.place(
            relx=0.792, rely=0.588, relwidth=0.176, relheight=0.277
        )
        self.P3_Command_StartTestVar = StringVar(value="开始测试")
        self.style.configure("TP3_Command_StartTest.TButton", font=("", 10))
        self.P3_Command_StartTest = Button(
            self.Frame10,
            text="开始测试",
            textvariable=self.P3_Command_StartTestVar,
            command=lambda: self.asynchronous(self.P3_Command_StartTest_Cmd),
            style="TP3_Command_StartTest.TButton",
        )
        self.P3_Command_StartTest.setText = lambda x: self.P3_Command_StartTestVar.set(
            x
        )
        self.P3_Command_StartTest.text = lambda: self.P3_Command_StartTestVar.get()
        self.P3_Command_StartTest.place(
            relx=0.792, rely=0.181, relwidth=0.176, relheight=0.277
        )
        self.P3_Text_BlocksVar = StringVar(value="3")
        self.P3_Text_Blocks = Entry(
            self.Frame10, textvariable=self.P3_Text_BlocksVar, font=("", 10)
        )
        ...
        self.P3_Text_Blocks.place(
            relx=0.174, rely=0.791, relwidth=0.129, relheight=0.141
        )
        self.Text_StarBlockVar = StringVar(value="0")
        self.Text_StarBlock = Entry(
            self.Frame10, textvariable=self.Text_StarBlockVar, font=("", 10)
        )
        ...
        self.Text_StarBlock.place(
            relx=0.174, rely=0.559, relwidth=0.129, relheight=0.141
        )
        self.P3_Text_MAIDVar = StringVar(value="3001")
        self.P3_Text_MAID = Entry(
            self.Frame10, textvariable=self.P3_Text_MAIDVar, font=("", 10)
        )
        ...
        self.P3_Text_Tested = Entry(
            self.Frame10, textvariable=self.P3_Text_TestedVar, font=("", 10)
        )
        ...
        self.P3_Text_Tested.place(
            relx=0.586, rely=0.768, relwidth=0.081, relheight=0.147
        )
        self.P3_Text_TestTotalVar = StringVar(value="10")
        self.P3_Text_TestTotal = Entry(
            self.Frame10, textvariable=self.P3_Text_TestTotalVar, font=("", 10)
        )
        ...
        self.P3_Text_TestTotal.place(
            relx=0.586, rely=0.452, relwidth=0.081, relheight=0.147
        )
        self.P3_Text_TestTimesVar = StringVar(value="5")
        self.P3_Text_TestTimes = Entry(
            self.Frame10, textvariable=self.P3_Text_TestTimesVar, font=("", 10)
        )
        ...
        self.P3_Text_TestTimes.place(
            relx=0.586, rely=0.136, relwidth=0.081, relheight=0.147
        )
        self.P3_Text_ReadTimerVar = StringVar(value="0.5")
        self.P3_Text_ReadTimer = Entry(
            self.Frame10, textvariable=self.P3_Text_ReadTimerVar, font=("", 10)
        )
        ...
        self.P3_Text_ReadTimer.place(
            relx=0.238, rely=0.136, relwidth=0.065, relheight=0.147
        )
        self.Label16Var = StringVar(value="Blocks")
        self.style.configure("TLabel16.TLabel", anchor="w", font=("", 10))
        self.Label16 = Label(
            self.Frame10,
            text="Blocks",
            textvariable=self.Label16Var,
            style="TLabel16.TLabel",
        )
        ...
        self.style.configure("TLabel14.TLabel", anchor="w", font=("", 10))
        self.Label14 = Label(
            self.Frame10,
            text="StarBlock",
            textvariable=self.Label14Var,
            style="TLabel14.TLabel",
        )
        ...
        self.style.configure("TLabel15.TLabel", anchor="w", font=("", 10))
        self.Label15 = Label(
            self.Frame10,
            text="MAID",
            textvariable=self.Label15Var,
            style="TLabel15.TLabel",
        )
        ...
        self.style.configure("TLabel19.TLabel", anchor="w", font=("", 10))
        self.Label19 = Label(
            self.Frame10,
            text="已测试卡数",
            textvariable=self.Label19Var,
            style="TLabel19.TLabel",
        )
        ...
        self.style.configure("TLabel18.TLabel", anchor="w", font=("", 10))
        self.Label18 = Label(
            self.Frame10,
            text="总测试卡数",
            textvariable=self.Label18Var,
            style="TLabel18.TLabel",
        )
        ...
        self.style.configure("TLabel17.TLabel", anchor="w", font=("", 10))
        self.Label17 = Label(
            self.Frame10,
            text="尝试次数",
            textvariable=self.Label17Var,
            style="TLabel17.TLabel",
        )
        ...
        self.style.configure("TLabel13.TLabel", anchor="w", font=("", 10))
        self.Label13 = Label(
            self.Frame10,
            text="ReadTimer(ms)",
            textvariable=self.Label13Var,
            style="TLabel13.TLabel",
        )
        ...
        self.style.configure("TP0_Check_antenna3.TCheckbutton", font=("", 10))
        self.P0_Check_antenna3 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna3Var,
            style="TP0_Check_antenna3.TCheckbutton",
        )
        ...
        self.P0_Check_antenna3.place(
            relx=0.609, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Check_antenna2Var = IntVar(value=0)
        self.style.configure("TP0_Check_antenna2.TCheckbutton", font=("", 10))
        self.P0_Check_antenna2 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna2Var,
            style="TP0_Check_antenna2.TCheckbutton",
        )
        ...
        self.P0_Check_antenna2.place(
            relx=0.514, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Check_antenna1Var = IntVar(value=1)
        self.style.configure("TP0_Check_antenna1.TCheckbutton", font=("", 10))
        self.P0_Check_antenna1 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna1Var,
            style="TP0_Check_antenna1.TCheckbutton",
        )
        ...
        self.P0_Check_antenna1.place(
            relx=0.42, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Combo_antennaList = ["0 ", "1 ", "2 ", "3 ", "4 ", "5 ", "6 "]
        self.P0_Combo_antennaVar = StringVar(value="1 ")
        self.P0_Combo_antenna = Combobox(
            self.Frame4,
            text="1 ",
            textvariable=self.P0_Combo_antennaVar,
            values=self.P0_Combo_antennaList,
            font=("", 10),
        )
        ...
        self.style.configure("TP0_Command_SetRWUnit.TButton", font=("", 10))
        self.TP0_Command_SetRWUnit = Button(
            self.Frame4,
            text="设置天线",
            textvariable=self.TP0_Command_SetRWUnitVar,
            command=self.TP0_Command_SetRWUnit_Cmd,
            style="TP0_Command_SetRWUnit.TButton.TButton",
        )
        ...
        self.TP0_Command_SetRWUnit.place(
            relx=0.609, rely=0.566, relwidth=0.345, relheight=0.363
        )

        self.Label5Var = StringVar(value="选择读写头：")
        self.style.configure("TLabel5.TLabel", anchor="w", font=("", 10))
        self.Label5 = Label(
            self.Frame4,
            text="选择读写头：",
            textvariable=self.Label5Var,
            style="TLabel5.TLabel",
        )
        ...
        self.style.configure("TLabel4.TLabel", anchor="w", font=("", 10))
        self.Label4 = Label(
            self.Frame4,
            text="天线轮询设置",
            textvariable=self.Label4Var,
            style="TLabel4.TLabel",
        )
        ...
        self.style.configure("TP0_Check_antenna6.TCheckbutton", font=("", 10))
        self.P0_Check_antenna6 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna6Var,
            style="TP0_Check_antenna6.TCheckbutton",
        )
        ...
        self.P0_Check_antenna6.place(
            relx=0.892, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Command_FindVar = StringVar(value="搜索读写器")
        self.style.configure("TP0_Command_Find.TButton", font=("", 10))
        self.P0_Command_Find = Button(
            self.Frame1,
            text="搜索读写器",
            textvariable=self.P0_Command_FindVar,
            command=lambda: self.asynchronous(self.P0_Command_Find_Cmd),
            style="TP0_Command_Find.TButton",
        )
        ...
        self.P0_Command_Find.place(
            relx=0.04, rely=0.566, relwidth=0.51, relheight=0.363
        )

        self.P0_Command1Var = StringVar(value="打开读写器")
        self.style.configure("TP0_Command1.TButton", font=("", 10))
        self.P0_Command1 = Button(
            self.Frame1,
            text="打开读写器",
            textvariable=self.P0_Command1Var,
            command=self.P0_Command1_Cmd,
            style="TP0_Command1.TButton",
        )
        ...
        self.style.configure("TP0_Command2.TButton", font=("", 10))
        self.P0_Command2 = Button(
            self.Frame1,
            text="关闭读写器",
            textvariable=self.P0_Command2Var,
            command=self.P0_Command2_Cmd,
            style="TP0_Command2.TButton",
        )
        ...
        self.P0_Combo_port = Combobox(
            self.Frame1,
            text="COM1",
            textvariable=self.P0_Combo_portVar,
            values=self.P0_Combo_portList,
            font=("", 10),
        )
        ...
        self.P0_Combo_regionList = [
            "CQ",
            "GZ",
        ]
        self.P0_Combo_regionVar = StringVar(value="CQ")
        self.P0_Combo_region = Combobox(
            self.Frame1,
            text="CQ",
            textvariable=self.P0_Combo_regionVar,
            values=self.P0_Combo_regionList,
            font=("", 10),
        )
        ...
        self.style.configure("TLabel2.TLabel", anchor="w", font=("", 10))
        self.Label2 = Label(
            self.Frame1, text="串口：", textvariable=self.Label2Var, style="TLabel2.TLabel"
        )
        ...
        self.style.configure("TLabel3.TLabel", anchor="w", font=("", 10))
        self.Label3 = Label(
            self.Frame1, text="地域：", textvariable=self.Label3Var, style="TLabel3.TLabel"
        )
        ...
        self.style.configure("TP0_Check_antenna5.TCheckbutton", font=("", 10))
        self.P0_Check_antenna5 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna5Var,
            style="TP0_Check_antenna5.TCheckbutton",
        )
        ...
        self.P0_Check_antenna5.place(
            relx=0.797, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Text_MsgVar = StringVar(value="")
        # self.P0_Text_Msg = Text(self.Frame3, textvariable=self.P0_Text_MsgVar, font=('',10))
        self.P0_Text_Msg = Text(self.Frame3, font=("", 10))
        self.P0_Text_Msg.setText = lambda x: self.P0_Text_MsgVar.set(x)
        self.P0_Text_Msg.text = lambda: self.P0_Text_MsgVar.get()
        self.P0_Text_Msg.place(relx=0.0, rely=0.03, relwidth=1.0, relheight=0.97)

        self.P0_Check_antenna4Var = IntVar(value=0)
        self.style.configure("TP0_Check_antenna4.TCheckbutton", font=("", 10))
        self.P0_Check_antenna4 = Checkbutton(
            self.Frame4,
            variable=self.P0_Check_antenna4Var,
            style="TP0_Check_antenna4.TCheckbutton",
        )
        ...
        self.P0_Check_antenna4.place(
            relx=0.703, rely=0.198, relwidth=0.082, relheight=0.252
        )

        self.P0_Text_MsgFont = Font(font=("", 10))
        self.P0_Text_Msg = Text(self.Frame3, font=self.P0_Text_MsgFont)
        self.P0_Text_Msg.place(relx=0.0, rely=0.0, relwidth=1.0, relheight=1.0)
...
class Application(Application_ui):
    ...
    def P1_Command_Diode_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            if (
                self.P1_Text_Diode1.get().isdigit()
                and self.P1_Text_Diode2.get().isdigit()
                and self.P1_Text_Diode3.get().isdigit()
            ):
                ...
                self.showmessage(
                    ...
                    % (
                        self.P1_Text_Diode1.get(),
                        self.P1_Text_Diode2.get(),
                        self.P1_Text_Diode3.get(),
                    )
                )
        else:
            self.P0_Text_Msg.insert("end", "读写器未打开" + "\n")
    ...
    def P1_Command_Buzzer_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            if (
                self.P1_Text_Buzzer1.get().isdigit()
                and self.P1_Text_Buzzer2.get().isdigit()
            ):
                num = int(self.P1_Text_Buzzer1.get())
                yd = int(self.P1_Text_Buzzer2.get())
                audiocontrolstat = str(
                    self.vfjreaderexample.audiocontrol(self.Handle, num, yd)
                )
                self.P0_Text_Msg.insert(
                ...
                self.showmessage(
                    ...
                    % (self.P1_Text_Buzzer1.get(), self.P1_Text_Buzzer2.get())
                )
        else:
            self.P0_Text_Msg.insert("end", "读写器未打开" + "\n")
    ...
    def P1_Command_ReaderVer_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            ...
            readerversionstat = self.vfjreaderexample.readerversion(
                hd, rdv, len(rdv), apiv, len(apiv)
            )
            self.P0_Text_Msg.insert(
                "end",
                "reader_readerversion:"
                + str(readerversionstat)
                + "\nversion:"
                + rdv.value.decode("utf-8")
                + " \napp:"
    ...
    def cpu_cmd(self, command):
        ...
        lenrep = ctypes.c_int()
        stat = self.vfjreaderexample.cpucommandself(
            self.Handle, command, len(command), reply, lenrep
        )
    ...
    def P2_Command_3F00_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            ...
            if cmd_stat["stat"] == 0:
                self.P0_Text_Msg.insert(
                    "end",
                    "执行指令:%s\n执行结果：%d,返回数据：" % (command, cmd_stat["stat"])
    ...
    def P2_Command_OpenCard_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            ...
            opencardstatus = self.vfjreaderexample.opencard(
                self.Handle, cardplace, cardsn
            )
            if opencardstatus == -1:
    ...
    def P3_Command_RFpsam_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            resamststus = self.vfjreaderexample.samreset(
                self.Handle, int(self.P3_Combo_PSAMposition.get()), 0
            )
            self.P0_Text_Msg.insert(
                "end",
                "复位卡槽%dpsam：%d \n"
    ...
    def P3_Command_PSAMcommand_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            ...
            reply = create_string_buffer(256)
            lenrep = ctypes.c_int()
            stat = self.vfjreaderexample.samcommand(
                self.Handle,
                int(self.P3_Combo_PSAMposition.get()),
                commands,
                len(commands),
                reply,
                lenrep,
    ...
    def P3_Command_StartTest_Cmd(self, event=None):
        if "vfjreaderexample" in dir(self):
            if (
                self.P3_Text_TestTimes.get().isdigit()
                and self.P3_Text_TestTotal.get().isdigit()
                and self.P3_Text_Tested.get().isdigit()
                and self.P3_Text_ReadTimer.get().isdigit()
            ):
    ...
    def P0_Command_Find_Cmd(self, event=None):
        try:
            ...
            for i in self.P0_Combo_portList:
                ...
                if stat > 0:
                    readerversion_test(
                        readerexample, stat, rdv, len(rdv), apiv, len(apiv)
                    )
                    self.P0_Text_Msg.insert(
                        "end",
                        "打开%s读写器成功,version:" % (i)
    ...
    def P0_Command1_Cmd(self, event=None):
        os_type = platform.system()
        try:
            self.vfjreaderexample = VFJReader(
                os_type,
                self.P0_Combo_region.get(),
                bytes(self.P0_Combo_port.get(), "utf-8"),
            )
